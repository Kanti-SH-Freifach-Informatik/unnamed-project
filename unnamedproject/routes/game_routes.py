...
from unnamedproject.controllers.game_controller import index, show, create, update, delete, draw, start, join
...
game_bp.route('/<int:game_id>/start', methods=['GET'])(start)
